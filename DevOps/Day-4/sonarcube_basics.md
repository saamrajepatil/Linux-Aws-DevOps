...
a web server that serves the SonarQube user interface. a search server based on Elasticsearch. 
...
The SonarQube instance configuration. One or more scanners running on your build or continuous integration servers to analyze projects.
